    ...
    >
      <div className="flex basis-1/3 items-center justify-start gap-2">
        <svg
          ...
          viewBox="0 0 698.2 725.21"
          className="size-20 fill-gray-300"
        >
      ...
      <ul className="flex basis-1/3 items-center justify-center gap-4">
        ...
        >
          <Link
            prefetch={false}
            href={"/"}
            className={`flex items-center justify-center gap-1 rounded-full bg-black px-4 py-2 text-white duration-300 hover:bg-white hover:text-black ${pathName === "/" && "bg-white !text-black"} `}
          >
        ...
        >
          <Link
            prefetch={false}
            href={"/Home/character"}
            className={`flex items-center justify-center gap-1 rounded-full bg-black px-4 py-2 text-white duration-300 hover:bg-white hover:text-black ${pathName === "/Home/character" && "bg-white !text-black"}`}
          >
            <BsFillPersonVcardFill className="size-6" />
            Characters
          </Link>
        </motion.li>
        <motion.li
        ...
        >
          <Link
            prefetch={false}
            href={"/Home/location"}
            className={`flex items-center justify-center gap-1 rounded-full bg-black px-4 py-2 text-white duration-300 hover:bg-white hover:text-black ${pathName === "/Home/location" && "bg-white !text-black"} `}
          >
        ...
        >
          <Link
            prefetch={false}
            href={"/Home/episode"}
            className={`flex items-center justify-center gap-1 rounded-full bg-black px-4 py-2 text-white duration-300 hover:bg-white hover:text-black ${pathName === "/Home/episode" && "bg-white !text-black"} `}
          >
            <MdLocalMovies className="size-6" />
            Episodes
          </Link>
        </motion.li>
      </ul>
